function replaceUrlParam(e, t, n) {
    var i = new RegExp("(" + t + "=).*?(&|$)"),
        r = e;
    return e.search(i) >= 0 ? e.replace(i, "$1" + n + "$2") : r + (r.indexOf("?") > 0 ? "&" : "?") + t + "=" + n
}! function(e) {
...
}(jQuery), "undefined" == typeof Haravan && (Haravan = {}), window.timber = window.timber || {}, timber.cacheSelectors = function() {
    timber.cache = {
        $html: $("html"),
        $body: $("body"),
    ...
    FastClick.attach(document.body), timber.cacheSelectors(), timber.accessibleNav(), timber.drawersInit(), timber.mobileNavToggle()
}, timber.accessibleNav = function() {
    var e = timber.cache.$navigation,
        t = e.find("a"),
        n = e.children("li").find("a"),
        i = e.find(".site-nav--has-dropdown"),
        r = e.find(".site-nav__dropdown").find("a"),
        o = "nav-hover",
        a = "nav-focus";
    ...
    i.on("mouseenter touchstart", function(e) {
        ...
        t.hasClass(o) || e.preventDefault(),
            function(e) {
                e.addClass(o), setTimeout(function() {
        ...
        ! function(e) {
            ...
            t ? c(e.closest(".site-nav--has-dropdown").find("a")) : (d(n), c(e))
        }($(this))
    }), t.blur(function() {
        d(n)
    })
}, timber.drawersInit = function() {
    timber.LeftDrawer = new timber.Drawers("NavDrawer", "left"), timber.RightDrawer = new timber.Drawers("CartDrawer", "right", {})
    ...
    var e = function(e, t, n) {
        ...
        if (this.$nodes = {
            ...
            }, this.config = $.extend(i, n), this.position = t, this.$drawer = $("#" + e), !this.$drawer.length) return !1;
    ...
    return e.prototype.init = function() {
        ...
        this.$nodes.moved.addClass("is-transitioning"), this.$drawer.prepareTransition(), this.$nodes.parent.addClass(this.config.openClass + " " + this.config.dirOpenClass), this.drawerIsOpen = !0, this.trapFocus(this.$drawer, "drawer_focus"), this.config.onDrawerOpen && "function" == typeof this.config.onDrawerOpen && (t || this.config.onDrawerOpen()), this.$activeSource && this.$activeSource.attr("aria-expanded") && this.$activeSource.attr("aria-expanded", "true"), this.$nodes.page.on("touchmove.drawer", function() {
            return !1
        ...
        e.attr("tabindex", "-1"), e.focus(), $(document).on(n, function(t) {
