                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input value="{{ @$item['phone_number'] != null ? strlen(strval(@$item['phone_number'])) == 9 ? '0' . @$item['phone_number'] : @$item['phone_number'] : 'Chưa có' }}" name="form[phone_number]" type="text" class="form-control" placeholder="Số điện thoại">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col">
