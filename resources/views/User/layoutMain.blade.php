    ...
    <script>
        ...
        $(function() {
            ...
            if(id_provinces_sending != 0){
                changeDistrictSending(id_provinces_sending, "{{ @$params['form']['districts_sending'] }}");
            }
        });
        ...
        var changeDistrictSending = function(id = 0, id_districts = 0){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    changeWardsSending(id_districts, "{{ @$params['form']['wards_sending'] }}");
                },
                error: function(){
                    console.log('Lỗi')
                }
        ...
        $(function() {
            ...
            if(id_provinces_receiver != 0){
                changeDistrictReceiver(id_provinces_receiver, "{{ @$params['form']['districts_receiver'] }}");
            }
        });
        ...
        var changeDistrictReceiver = function(id = 0, id_districts = 0){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    changeWardsReceiver(id_districts, "{{ @$params['form']['wards_receiver'] }}");
                },
                error: function(){
                    console.log('Lỗi')
                }
